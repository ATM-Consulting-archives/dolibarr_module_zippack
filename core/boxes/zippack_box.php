 ...
 */
class zippackbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "zippack@zippack";
    public $boxlabel;
    public $depends = array("zippack");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/zippack/class/zippack.class.php";
